...
public:
  /*Constructor*/
  //1.open or create
  ShmStringHashMap(const std::string & shm_name, const int & shm_bytes,
               const std::string & hashmap_name, const int & hashmap_size):
...
int main (int argc, char *argv[])
{
  ...
  if(which=="c"){
    ...
    ShmStringHashMap shm_hash("MizhangSharedMemory",6553600,"ShmHashMap1",3000);
